...
equation
  connect(sensor1.sensor_output, lf_1_sensor_reading) annotation(Line(points = {{14, 2}, {108, 2}}, color = {0, 0, 127}));
  connect(robot_theta, sensor1.robot_state[4]) annotation(Line(points = {{-100, -70}, {-66, -70}, {-66, -70}, {-40, -70}, {-40, 2}, {-8, 2}, {-8, 2}}, color = {0, 0, 127}));
  connect(robot_z, sensor1.robot_state[3]) annotation(Line(points = {{-100, -30}, {-48, -30}, {-48, 2}, {-8, 2}, {-8, 2}}, color = {0, 0, 127}));
  connect(robot_y, sensor1.robot_state[2]) annotation(Line(points = {{-100, 30}, {-48, 30}, {-48, 2}, {-8, 2}, {-8, 2}}, color = {0, 0, 127}));
  connect(robot_x, sensor1.robot_state[1]) annotation(Line(points = {{-100, 70}, {-40, 70}, {-40, 2}, {-8, 2}, {-8, 2}}, color = {0, 0, 127}));
