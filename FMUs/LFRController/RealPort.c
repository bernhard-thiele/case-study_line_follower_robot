...
SET_FIELD_PTR_GC(RealPort, RealPort, this, value, field_tmp_4);
...
/* Fmi.vdmrt 81:26 */
TVP ret_9 = vdmCloneGC(GET_FIELD_PTR_GC(RealPort, RealPort, this, value), &ret_9)
;
/* Fmi.vdmrt 81:19 */
return ret_9;
}
...
RealPortCLASS RealPort_Constructor(RealPortCLASS this_ptr)
{
	...
	if(this_ptr!=NULL)
	{
		...
		this_ptr->_RealPort_pVTable=VTableArrayForRealPort;
				...
				this_ptr->m_RealPort_value= _Z17fieldInitializer5EV();
			}
